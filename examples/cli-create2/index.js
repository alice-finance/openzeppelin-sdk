const { ConfigManager, files, scripts, stdout } = require('@alice-finance/oz-cli');
const { helpers, Contracts } = require('@alice-finance/oz-upgrades');
...
async function useSignedCreate2(initValue, networkConfig) {    
  ...
  // We now ask @alice-finance/oz-upgrades to sign the request for us
